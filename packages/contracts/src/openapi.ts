...
const OPERATIONS: OperationSpec[] = [
  ...
  },
  {
    ...
    summary: 'Return the current session, workspace and permission set',
    tag: 'auth',
    response: A.SessionResponse,
  },
  {
    method: 'post',
  ...
  },
  {
    ...
    tag: 'auth',
    response: z.object({ secret: z.string(), otpauthUrl: z.string(), factorId: z.string() }),
  },
  {
    method: 'post',
    path: '/api/v1/auth/mfa/activate',
    operationId: 'authMfaActivate',
    summary: 'Activate TOTP after verifying a code',
    tag: 'auth',
    request: z.object({ factorId: z.string(), code: z.string() }),
    response: z.object({ ok: z.literal(true), recoveryCodes: z.array(z.string()) }),
  },
  {
    method: 'post',
    ...
    tag: 'auth',
    request: A.ForgotPasswordRequest,
    response: z.object({ ok: z.literal(true) }),
    public: true,
  },
  {
    ...
    tag: 'auth',
    request: A.ResetPasswordRequest,
    response: z.object({ ok: z.literal(true) }),
    public: true,
  },
  {
  ...
  },
  {
    ...
    tag: 'auth',
    response: z.array(A.DeviceSession),
  },
  {
    method: 'delete',
  ...
  // --- dashboard ----------------------------------------------------------
  {
    ...
    summary: 'Dashboard KPIs, activity, outcomes and attention items',
    tag: 'dashboard',
    permission: 'workspace:read',
    query: A.DashboardQuery,
    response: A.DashboardResponse,
  },
  ...
  },
  {
    ...
    request: A.CreateConsultationRequest,
    response: A.ConsultationDetail,
    status: 201,
  },
  {
    method: 'get',
    ...
    summary: 'Full consultation with messages, sources and evidence',
    tag: 'consultations',
    permission: 'consultation:read',
    response: A.ConsultationDetail,
  },
  {
    ...
    summary: 'Rename, re-scope or change answer settings',
    tag: 'consultations',
    permission: 'consultation:update',
    request: A.UpdateConsultationRequest,
    response: A.ConsultationDetail,
  },
  {
    method: 'delete',
    ...
    tag: 'consultations',
    permission: 'consultation:delete',
    response: z.object({ ok: z.literal(true) }),
  },
  {
    method: 'post',
    path: '/api/v1/consultations/{id}/messages',
    operationId: 'postMessage',
    summary: 'Ask a question and queue a grounded answer',
    tag: 'consultations',
    permission: 'consultation:update',
    request: A.PostMessageRequest,
    response: z.object({ message: A.ConsultationMessage, job: A.JobView }),
    status: 202,
    idempotent: true,
  },
  {
    method: 'post',
    path: '/api/v1/consultations/{id}/cancel',
    operationId: 'cancelConsultationWork',
    summary: 'Cancel in-flight generation',
    tag: 'consultations',
    permission: 'consultation:update',
    response: z.object({ ok: z.literal(true), cancelled: z.number().int() }),
  },
  {
    method: 'post',
    path: '/api/v1/consultations/{id}/uploads',
    operationId: 'createConsultationUpload',
    summary: 'Attach customer documents as consultation inputs',
    tag: 'consultations',
    permission: 'consultation:update',
    request: A.CreateUploadRequest,
    response: z.object({ tickets: z.array(A.UploadTicket) }),
    status: 201,
  },
  {
    method: 'post',
    ...
    summary: 'Run a requirement-by-requirement compliance review',
    tag: 'consultations',
    permission: 'review:create',
    request: A.CreateReviewRequest,
    response: z.object({ job: A.JobView }),
    status: 202,
    idempotent: true,
  },
  {
    method: 'post',
    path: '/api/v1/consultations/{id}/reports',
    operationId: 'createReport',
    summary: 'Generate an evidence-backed report artifact',
    tag: 'consultations',
  ...
  {
    method: 'post',
    path: '/api/v1/consultations/{id}/corrections',
    operationId: 'createCorrection',
    summary: 'Build a reviewable correction plan',
    tag: 'consultations',
    permission: 'correction:create',
    request: A.CreateCorrectionRequest,
    response: z.object({ job: A.JobView }),
    status: 202,
    idempotent: true,
  },
  {
    method: 'get',
    path: '/api/v1/consultations/{id}/stream',
    operationId: 'streamConsultation',
    summary: 'Server-sent events for answers and job progress',
    tag: 'consultations',
    permission: 'consultation:read',
    response: A.StreamEvent,
  },
  {
    method: 'patch',
    path: '/api/v1/corrections/{planId}',
    operationId: 'decideCorrection',
    summary: 'Accept, reject or edit individual proposed changes',
    tag: 'corrections',
    permission: 'correction:decide',
    request: A.DecideCorrectionRequest,
    response: A.CorrectionPlan,
  },
  {
    method: 'post',
    path: '/api/v1/corrections/{planId}/generate',
    operationId: 'generateCorrection',
    summary: 'Produce the corrected edition from accepted changes only',
    tag: 'corrections',
    permission: 'correction:generate',
    request: A.GenerateCorrectionRequest,
    response: z.object({ job: A.JobView }),
    status: 202,
    idempotent: true,
  },
  {
    ...
    summary: 'Correction plan with side-by-side diff',
    tag: 'corrections',
    permission: 'correction:create',
    response: A.CorrectionPlan,
  },
  ...
  // --- jobs ---------------------------------------------------------------
  {
    ...
    path: '/api/v1/jobs/{id}',
    operationId: 'getJob',
    summary: 'Job status, stages and failure reason',
    tag: 'jobs',
    response: A.JobView,
  },
  {
    ...
    summary: 'Retry a failed job without duplicating artifacts',
    tag: 'jobs',
    response: A.JobView,
    idempotent: true,
  },
  ...
  // --- sources ------------------------------------------------------------
  {
    ...
    summary: 'Knowledge base sources the caller may see',
    tag: 'sources',
    permission: 'source:read',
    query: A.SourcesQuery,
    response: A.SourcesResponse,
  },
  {
    method: 'post',
    path: '/api/v1/sources/uploads',
    operationId: 'createSourceUpload',
    summary: 'Request resumable upload tickets',
    tag: 'sources',
  ...
  {
    method: 'post',
    path: '/api/v1/sources/connectors',
    operationId: 'createConnector',
    summary: 'Connect Drive/OneDrive/SharePoint/URL or paste text',
    tag: 'sources',
    permission: 'source:create',
    request: A.CreateConnectorRequest,
    response: z.object({ sourceId: z.string(), job: A.JobView }),
    status: 202,
    idempotent: true,
  },
  {
    ...
    summary: 'Source detail, versions, permissions and processing log',
    tag: 'sources',
    permission: 'source:read',
    response: A.SourceDetail,
  },
  {
    method: 'patch',
    path: '/api/v1/sources/{id}',
    operationId: 'updateSource',
    summary: 'Rename, retag, re-scope or archive a source',
    tag: 'sources',
    permission: 'source:update',
    request: A.UpdateSourceRequest,
    response: A.SourceDetail,
  },
  {
    method: 'post',
    path: '/api/v1/sources/{id}/reprocess',
    operationId: 'reprocessSource',
    summary: 'Re-run extraction and indexing',
    tag: 'sources',
  ...
  },
  {
    ...
    summary: 'Pull the latest connector content',
    tag: 'sources',
    permission: 'source:reprocess',
    response: z.object({ job: A.JobView }),
    status: 202,
  ...
  {
    method: 'get',
    path: '/api/v1/sources/{id}/versions',
    operationId: 'listSourceVersions',
    summary: 'Immutable version lineage',
    tag: 'sources',
    permission: 'source:read',
    response: z.array(A.SourceVersionSummary),
  },
  {
    method: 'post',
    path: '/api/v1/sources/bulk',
    operationId: 'bulkSourceAction',
    summary: 'Tag, re-scope, reprocess, archive, export or delete in bulk',
    tag: 'sources',
    permission: 'source:update',
    request: A.BulkSourceActionRequest,
    response: z.object({ affected: z.number().int() }),
  },
  ...
  // --- citations & artifacts ---------------------------------------------
  {
    ...
    summary: 'Open a citation at its exact location with highlight offsets',
    tag: 'citations',
    permission: 'source:read',
    response: A.CitationResolution,
  },
  {
    method: 'get',
    path: '/api/v1/artifacts',
    operationId: 'listArtifacts',
    summary: 'Report and corrected-document library',
    tag: 'artifacts',
    permission: 'artifact:read',
    query: A.ReportsQuery,
  },
  {
    method: 'get',
    path: '/api/v1/artifacts/{id}/download',
    operationId: 'downloadArtifact',
    summary: 'Short-lived signed download for an artifact',
    tag: 'artifacts',
    permission: 'artifact:download',
    response: z.object({ url: z.string(), expiresAt: z.string(), fileName: z.string() }),
  },
  ...
  },
  {
    ...
    summary: 'Workspace members and their access',
    tag: 'users',
    permission: 'member:read',
    response: z.array(A.WorkspaceUser),
  },
  {
    method: 'post',
    ...
    request: A.InviteUserRequest,
    response: A.WorkspaceUser,
    status: 201,
  },
  {
    method: 'patch',
    ...
    summary: 'Change role, suspend, or revoke sessions',
    tag: 'users',
    permission: 'member:update',
    request: A.UpdateUserRequest,
    response: A.WorkspaceUser,
  },
  {
    method: 'get',
    ...
    summary: 'Workspace settings and model configuration',
    tag: 'settings',
    permission: 'settings:read',
    response: z.object({ settings: A.WorkspaceSettings, models: z.array(A.ModelConfiguration) }),
  },
  {
    method: 'patch',
    path: '/api/v1/settings',
    ...
    request: A.UpdateSettingsRequest,
    response: A.WorkspaceSettings,
  },
  {
    method: 'post',
    path: '/api/v1/settings/models',
    operationId: 'upsertModelConfig',
    summary: 'Configure a provider for a capability',
    tag: 'settings',
    permission: 'settings:models',
    request: A.UpsertModelConfigRequest,
    response: A.ModelConfiguration,
  },
  {
    method: 'post',
    path: '/api/v1/settings/models/{id}/test',
    operationId: 'testModelConfig',
    summary: 'Verify provider credentials and report health',
    tag: 'settings',
    permission: 'settings:models',
    response: A.ModelConfiguration,
  },
  ...
  },
  {
    ...
    path: '/api/v1/ready',
    operationId: 'ready',
    summary: 'Readiness including database and document worker',
    tag: 'system',
    response: A.HealthResponse,
    public: true,
  },
